...
type RespTokenOverview struct {
	...
	PriceChange1mPercent  float64 `json:"priceChange1mPercent"`
	PriceChange5mPercent  float64 `json:"priceChange5mPercent"`
	...
	UniqueWallet1m               int64   `json:"uniqueWallet1m"`
	UniqueWalletHistory1m        int64   `json:"uniqueWalletHistory1m"`
	UniqueWallet1mChangePercent  float64 `json:"uniqueWallet1mChangePercent"`
	UniqueWallet5m               int64   `json:"uniqueWallet5m"`
	UniqueWalletHistory5m        int64   `json:"uniqueWalletHistory5m"`
	UniqueWallet5mChangePercent  float64 `json:"uniqueWallet5mChangePercent"`
	...
	Trade1m              int64   `json:"trade1m"`
	TradeHistory1m       int64   `json:"tradeHistory1m"`
	Trade1mChangePercent float64 `json:"trade1mChangePercent"`
	Sell1m               int64   `json:"sell1m"`
	SellHistory1m        int64   `json:"sellHistory1m"`
	Sell1mChangePercent  float64 `json:"sell1mChangePercent"`
	Buy1m                int64   `json:"buy1m"`
	BuyHistory1m         int64   `json:"buyHistory1m"`
	Buy1mChangePercent   float64 `json:"buy1mChangePercent"`
	V1m                  float64 `json:"v1m"`
	V1mUSD               float64 `json:"v1mUSD"`
	VHistory1m           float64 `json:"vHistory1m"`
	VHistory1mUSD        float64 `json:"vHistory1mUSD"`
	V1mChangePercent     float64 `json:"v1mChangePercent"`
	VBuy1m               float64 `json:"vBuy1m"`
	VBuy1mUSD            float64 `json:"vBuy1mUSD"`
	VBuyHistory1m        float64 `json:"vBuyHistory1m"`
	VBuyHistory1mUSD     float64 `json:"vBuyHistory1mUSD"`
	VBuy1mChangePercent  float64 `json:"vBuy1mChangePercent"`
	VSell1m              float64 `json:"vSell1m"`
	VSell1mUSD           float64 `json:"vSell1mUSD"`
	VSellHistory1m       float64 `json:"vSellHistory1m"`
	VSellHistory1mUSD    float64 `json:"vSellHistory1mUSD"`
	VSell1mChangePercent float64 `json:"vSell1mChangePercent"`

	Trade5m              int64   `json:"trade5m"`
	TradeHistory5m       int64   `json:"tradeHistory5m"`
	Trade5mChangePercent float64 `json:"trade5mChangePercent"`
	Sell5m               int64   `json:"sell5m"`
	SellHistory5m        int64   `json:"sellHistory5m"`
	Sell5mChangePercent  float64 `json:"sell5mChangePercent"`
	Buy5m                int64   `json:"buy5m"`
	BuyHistory5m         int64   `json:"buyHistory5m"`
	Buy5mChangePercent   float64 `json:"buy5mChangePercent"`
	V5m                  float64 `json:"v5m"`
	V5mUSD               float64 `json:"v5mUSD"`
	VHistory5m           float64 `json:"vHistory5m"`
	VHistory5mUSD        float64 `json:"vHistory5mUSD"`
	V5mChangePercent     float64 `json:"v5mChangePercent"`
	VBuy5m               float64 `json:"vBuy5m"`
	VBuy5mUSD            float64 `json:"vBuy5mUSD"`
	VBuyHistory5m        float64 `json:"vBuyHistory5m"`
	VBuyHistory5mUSD     float64 `json:"vBuyHistory5mUSD"`
	VBuy5mChangePercent  float64 `json:"vBuy5mChangePercent"`
	VSell5m              float64 `json:"vSell5m"`
	VSell5mUSD           float64 `json:"vSell5mUSD"`
	VSellHistory5m       float64 `json:"vSellHistory5m"`
	VSellHistory5mUSD    float64 `json:"vSellHistory5mUSD"`
	VSell5mChangePercent float64 `json:"vSell5mChangePercent"`
